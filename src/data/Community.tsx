...
export const games: ItemProps[] = [
    ...
    },
    {
        ...
        posterUrl: '/images/community/posters/Decentraland.png',
    ...
    },
    {
        ...
        posterUrl: '/images/community/posters/webb.png',
    ...
    },
    {
        ...
        posterUrl: '/images/community/posters/Aave.png',
    ...
    },
    {
        ...
        posterUrl: '/images/community/posters/MiniRoyale.png',
...
export const games2: ItemProps[] = [
    {
        id: 5,
        avatarUrl: '/images/community/avatars/Picture (1).png',
        backUrl: '/images/community/posters/Deff.png',
        posterUrl: '/images/community/posters/img.png',
    ...
    },
    {
        ...
        backUrl: '/images/community/posters/Somnium.png',
        posterUrl: '/images/community/posters/MiniRoyale.png',
        communityName: 'Somnium',
        collectionName: 'Somnium',
        memberNumber: 8000,
        totalSupply: 37000,
        icon: <MemberIcon />,
    ...
    },
    {
        ...
        backUrl: '/images/community/posters/Aurory.png',
        posterUrl: '/images/community/posters/DefiLand.png',
        communityName: 'Aurory',
        collectionName: 'DefiLand',
        memberNumber: 5700,
        totalSupply: 1234,
        icon: <MemberIcon />,
        description: "DeFi, Gaming, NFTs and Metaverse reimagined in a new and all-in-one game🚜🚜🚜Join to farm, trade, compete, craft and more. Public beta is now open!",
        walletAddress: '9jKipb3AbeNNZWtaJ6vgYPPBGZg2mX8Gqp1bU1SjeRDc',
    ...
    {
        avatarUrl: '/images/community/avatars/Picture (6).png',
        backUrl: '/images/community/posters/MiniRoyale.png',
        posterUrl: '/images/community/posters/MiniRoyale.png',
        ...
        backUrl: '/images/community/posters/DoubleJump.png',
        posterUrl: '/images/community/posters/evio.png',
        communityName: 'DoubleJump',
        collectionName: 'DoubleJump',
        memberNumber: 2400,
        totalSupply: 1100,
        icon: <MemberIcon />,
...
export const games3: ItemProps[] = [
    {
        id: 5,
        avatarUrl: '/images/community/avatars/Picture (1).png',
        backUrl: '/images/community/posters/Webaverse.png',
        posterUrl: '/images/community/posters/img.png',
        communityName: 'Webaverse',
        collectionName: 'Webaverse',
        memberNumber: 3200,
        totalSupply: 10000,
        icon: <MemberIcon />,
        description: "Aurory, a PvE/PvP gaming project using NFTs, powered by Solana and Serum.",
    ...
    {
        avatarUrl: '/images/community/avatars/Picture (6).png',
        backUrl: '/images/community/posters/Portals.png',
        posterUrl: '/images/community/posters/MiniRoyale.png',
    ...
    {
        avatarUrl: '/images/community/avatars/DefiLand.png',
        backUrl: '/images/community/posters/evio.png',
        posterUrl: '/images/community/posters/DefiLand.png',
        communityName: 'Ev.io',
        collectionName: 'Ev.io',
        memberNumber: 5700,
        totalSupply: 1234,
        icon: <MemberIcon />,
        description: "DeFi, Gaming, NFTs and Metaverse reimagined in a new and all-in-one game🚜🚜🚜Join to farm, trade, compete, craft and more. Public beta is now open!",
    ...
    {
        avatarUrl: '/images/community/avatars/Picture (6).png',
        backUrl: '/images/community/posters/Decentraland.png',
        posterUrl: '/images/community/posters/MiniRoyale.png',
        communityName: 'Decentraland',
        collectionName: 'Decentralnd',
        memberNumber: 8000,
        totalSupply: 37000,
        icon: <MemberIcon />,
        description: "War, deception, and destruction ravages the Miniverse. Vikings, channeling the power of Odin, have descended upon the Miniverse to compete in quests, form powerful clans, and seize control. Let the battles begin.",
        ...
        {
        avatarUrl: '/images/community/avatars/Picture (3).png',
        backUrl: '/images/community/posters/webb.png',
        posterUrl: '/images/community/posters/evio.png',
        communityName: 'Worldwide Webb',
        collectionName: 'Worldwide Webb',
        memberNumber: 2400,
        totalSupply: 1100,
        icon: <MemberIcon />,
        description: "Ev.io is a play to earn blockchain FPS - equip a character skin, weapon and sword to start earning e (which converts to SOL) for every kill. Equip all 3 to unlock maximum earning potential. Play at https://ev.io!",
